...
CREATE TABLE IF NOT EXISTS "arrienda_ya_tipousuario"(
  "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
  "tipo" varchar(1) NOT NULL
);
CREATE TABLE IF NOT EXISTS "arrienda_ya_usuario"(
  "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE IF NOT EXISTS "arrienda_ya_inmueble"(
  "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
  "tipo_inmueble" varchar(60) NOT NULL,
  "nombre_inmueble" varchar(100) NOT NULL,
  "descripcion" text NOT NULL,
  "m2_construido" real NOT NULL,
  "numero_banos" integer NOT NULL,
  "numero_habitaciones" integer NOT NULL,
  "direccion" varchar(100) NOT NULL,
  "id_usuario_id" bigint NULL REFERENCES "arrienda_ya_usuario"("id") DEFERRABLE INITIALLY DEFERRED
);
CREATE INDEX "arrienda_ya_inmueble_id_usuario_id_f0ff9d57" ON "arrienda_ya_inmueble"(
  "id_usuario_id"
);
